...
import com.migame.mtower.util.DialogUtil;
        ...
        switch (this.id) {
            ...
            case 2:     // 第 0 层 仙子 找到宝物后
                messages = new String[] {
                    ...
                    "    这个东西是仙界的圣物名叫“灵之杖”，是很久以前的一个圣者留下的。\n" +
                    "    它们一共有三个，分别镶这红、绿、蓝三种颜色的宝石。\n" +
                    "    你现在拿着的是一颗镶有蓝宝石的“冰之灵杖”应该还有一个镶着绿宝石的“心之灵杖”和镶有红宝石的“炎之灵杖”。\n" +
                    "    在这座塔的下面，封印着一只魔界的世兽，名叫“血影”，这三把“灵之杖”就是封印的钥匙。",
                    "    封印钥匙？",
                    "    每一个“灵之杖”里面都有着很强的魔法力量，如果被恶魔得到了将会使它的力量倍增。\n" +
                    "    如果被恶魔将它们三个找齐的话。\n" +
                    "    那么“血影”的封印便会解除！\n" +
                    "    勇士，你还是快去把我要的东西找来吧，等我恢复了魔力，我就可以帮你将“灵之杖”中的魔力都开放出来！\n" +
                    "    记住：如果你没有足够的实力的话，不要去第二十一层！在那一层里，你所有宝物的法力都会失去作用！"
                };
                break;
            case 3:     // 第 15 层 神秘老人 不够 500 经验
                messages = new String[] {
                    "",
                    "     你好，勇敢的孩子，你终于来到这里了。\n" +
                    "    我将给你一个非常好的宝物，它可以使你的攻击力提升 120 点，但这必须得用你的 500 点经验来进行交换，考虑一下子吧！",
                    "    这，可我现在还没有那么多的经验。",
                    "    那等你的经验够了而且想要的时候再来吧！"
                };
                break;
            ...
            case 5:     // 第 16 层 神秘老人 神秘宝物
                messages = new String[] {
                    ...
                    "    年青人，你终于来了！",
                    "    您怎么了？",
                    "    我已经快封不住它了，请你将这个东西交给彩蝶仙子，她会告诉你这是什么东西，有什么用的！\n" +
                    "    快去吧，再迟就来不及了！"
                };
                break;
            case 6:     // 第 2 层 商人
            ...
            case 7:     // 第 15 层 商人 不够 500 金币
                messages = new String[] {
                    ...
                    "    什么宝物？要多少钱？",
                    "    是这个游戏里最好的盾牌，防御值可以增加 120 点，而你只要出 500 个金币就可以买下。\n" +
                    "    怎么样？你有 500 个金币吗？",
                    "    ······\n    现在还没有。",
                    "    那等你有了而且想要的时候再来找我吧！"
                };
